...
#Get shuffle index
train_video_indices, validation_video_indices = input_data.get_video_indices(TRAIN_LIST_PATH)
    ...
    with tf.Session(config=config) as sess:
        ...
        for epoch in range(EPOCH_NUM):
            ...
            for i in range(len(train_video_indices) // BATCH_SIZE):
                step += 1
                batch_data, batch_index = input_data.get_batches(TRAIN_LIST_PATH, NUM_CLASSES, batch_index,
